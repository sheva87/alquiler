(function(c) {
    var a = ["rollIn", "fadeIn", "fadeInUp", "fadeInDown", "fadeInLeft", "fadeInRight", "fadeInRight", "bounceIn", "bounceInDown", "bounceInUp", "bounceInLeft", "bounceInRight", "rotateIn", "rotateInDownLeft", "rotateInDownRight", "rotateInUpLeft", "rotateInUpRight", "fadeInLeftBig", "fadeInRightBig", "flipInX", "flipInY"];
    var b = a.length;
    c.fn.oneByOne = function(h) {
        var E = {className: "oneByOne", sliderClassName: "oneByOne_item", pauseByHover: true, easeType: "fadeInLeft", width: 960, height: 420, minWidth: 480, delay: 300, tolerance: 0.25, enableDrag: true, showArrow: true, showButton: true, slideShow: false, slideShowDelay: 5000, responsive: false, autoHideButton: false};
        if (h) {
            c.extend(E, h)
        }
        var q;
        ...
        function u(i) {
            ...
            y.stop(true, true).animate({left: -i * D}, E.delay, function() {
                if (i != H) {
                    z = H;
                    if (e[z]) {
                    ...
                    if (E.easeType.toLowerCase() != "random") {
                        e[i].show().children().each(function(L) {
                            ...
                            if (c.browser.msie && c.browser.version <= 9) {
                                M.css("opacity", 0);
                                M.show().animate({opacity: 1}, 200 + 200 * K)
                            } else {
                                if (J) {
